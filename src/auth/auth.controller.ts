...
export class AuthController {
  ...
  @ApiOperation({
    description: paragraph(
      'Authenticates a user using a `passKey` and returns an `accessToken` with a limited validity period (2 hours). Once the token expires, a new token must be generated by using the this endpoint.',
      '',
